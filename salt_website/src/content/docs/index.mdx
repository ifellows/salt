...
The SALT software supports every link-tracing design in this table except Snowball — SALT Sampling, RDS, Starfish, and BBS-lite all track recruitment links and can be implemented using the same tablet app and management server. See [Statistical Validity](/getting-started/statistical-validity/) for how each design addresses the biases inherent in network-based sampling.
