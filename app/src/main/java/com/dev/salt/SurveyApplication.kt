...
class SurveyApplication : Application() {
    ...
    fun populateSampleData() {
        ...
        if (dao.getAllQuestions().isEmpty()) {
            ...
            dao.insertQuestion(Question(1, 1, "Have you every been told by a doctor or nurse that you have HIV?","question1.mp3",
            ...
            dao.insertQuestion(Question(2, 2, "When was the last time you were tested for HIV?","question2.mp3",
            ...
            dao.insertQuestion(Question(3, 3,"Did you use a condom with the last partner you had anal sex with?","question3.mp3",
            ...
            dao.insertQuestion(Question(4, 4,"How many sexual partners have you had in the last month?","question4.mp3",
